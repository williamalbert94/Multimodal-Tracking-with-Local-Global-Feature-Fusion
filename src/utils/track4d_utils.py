...
def filter_object_points_batch(args, labels_batch, pc_batch, transforms_batch):
    ...
    for b in range(batch_size):
        ...
        gt_mov_pts, gt_cls, gt_objs, objs_idx, objs_centre, cls_obj_id, boxes, objs_combined, objs_idx_combined, objs_centre_combined = filter_object_points(
    ...
    return (gt_mov_pts_batch, gt_cls_batch, gt_objs_batch, objs_idx_batch,
            ...
            objs_idx_combined_batch, objs_centre_combined_batch)
